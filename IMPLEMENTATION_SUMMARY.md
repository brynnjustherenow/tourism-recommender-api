...
/recommendors/:id           - 推荐官详情（待完成）
/destinations               - 公开目的地列表（待完成）
```
...
```bash
# 需要创建的页面
- frontend/pages/RecommendorsPublic.jsx
- frontend/pages/RecommendorDetail.jsx
- frontend/pages/DestinationDetail.jsx
- frontend/pages/DestinationManagement.jsx
```
